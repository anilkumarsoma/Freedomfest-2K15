...
function nexus_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['nexus_settings']['slideshow']['slideimage'] = array(
    '#markup' => t('To change the Slide Images, Replace the slide-image-1.jpg, slide-image-2.jpg, slide-image-3.jpg and slide-image-4.jpg in the images folder of the theme folder.'),
  );
}
